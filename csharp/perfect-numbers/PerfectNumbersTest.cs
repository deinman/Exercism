...
public class PerfectNumbersTest
{
    ...
    [Fact]
    public void example_abundant2()
    {
        Assert.Equal(Classification.Abundant, PerfectNumbers.Classify(24));
    }
    [Fact]
    public void example_deficient1()
    {
        Assert.Equal(Classification.Deficient, PerfectNumbers.Classify(8));
    }
    [Fact]
    public void example_deficient2()
    {
        Assert.Equal(Classification.Deficient, PerfectNumbers.Classify(17));
    }
